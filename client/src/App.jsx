        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-5">
          <div className="space-y-1">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-indigo-300">
              Live Chat· Instant Delivery
            </p>
            <h1 className="text-2xl font-semibold text-white">
              Chumbi Nyiri Chat
            </h1>
            <p className="text-sm text-slate-400">
              Fast. Secure. Human-Focused Messaging.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <SignedOut>
              <SignInButton mode="modal">
                <Button variant="secondary">Welcome Back — Sign in</Button>
              </SignInButton>
            </SignedOut>
            <SignedIn>
        ...
        <SignedOut>
          <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 text-center text-slate-200">
            <h2 className="text-3xl font-semibold text-white">
              Welcome to Chumbi Nyiri Chat!
            </h2>
            <p className="mt-3 text-base text-slate-400">
              Login to join the conversation and chat in real time with your friends & team.
            </p>
            <SignInButton mode="modal">
